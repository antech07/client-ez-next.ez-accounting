    ...
    <section className="relative w-full bg-[#FEFEFE]">
      ...
      <div className="relative mt-[60px] h-[350px] w-full md:mt-[72px] md:h-[45vh]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          <h1 className="font-fustat text-4xl font-bold leading-[50px] text-white md:text-[48px]">
            Tax Filing
          </h1>

          <div className="ml-[40px] h-[6px] w-[120px] bg-[#F36C24] md:ml-[55px] md:mt-1 md:w-[150px]" />
        </div>
      </div>
    </section>
  );
